...
class FactoryConexion
{
    ...
    public static string CreateConnection()
    {
        ...
        {
            if (ConfigurationManager.ConnectionStrings[i].Name.Equals("appMarket.Properties.Settings.SqlServer", StringComparison.InvariantCultureIgnoreCase))
                existe = true;
        }
        ...
        conexion.AppendFormat("{0}", ConfigurationManager.ConnectionStrings["appMarket.Properties.Settings.SqlServer"].ConnectionString);
